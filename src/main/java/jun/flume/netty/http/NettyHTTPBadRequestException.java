 ...
 * 
 */
public class NettyHTTPBadRequestException extends FlumeException {

	private static final long serialVersionUID = -3540764742069390951L;

	public NettyHTTPBadRequestException(String msg) {
		super(msg);
	}

	public NettyHTTPBadRequestException(String msg, Throwable th) {
		super(msg, th);
	}

	public NettyHTTPBadRequestException(Throwable th) {
		super(th);
	}
}
