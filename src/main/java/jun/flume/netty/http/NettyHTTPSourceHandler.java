 ...
 *
 */
public interface NettyHTTPSourceHandler extends Configurable {
	 ...
	 * @throws NettyHTTPBadRequestException
	 *             If the was not parsed correctly into an event because the
	 *             request was not in the expected format.
	 * @throws Exception
